...
class TestAPIController extends ControllerBase {
	...
	public function get_example(Request $request) {
		$response['data'] = 'Some test data to return using GET';
		$response['method'] = 'GET';
	...
	public function put_example(Request $request) {
		$response['data'] = 'Some test data to return using PUT';
		$response['method'] = 'PUT';
		return new JsonResponse( $response );
	}
	...
	public function post_example(Request $request) {
		...
		$response['data'] = 'Some test data to return using POST';
	...
	public function delete_example(Request $request) {
		$response['data'] = 'Some test data to return using DELETE';
